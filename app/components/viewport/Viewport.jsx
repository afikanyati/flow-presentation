            ...
            <Container id="viewport">
                        ...
                        {this.state.trailingWord.map((word, index, arr) => {
                            return (
                                <Word
                                    ...
                                    value={(index != arr.length - 1) ? `${word} ` : word}
                ...
                <FutureContainer
                    ...
                    <Future
                        fontSize={this.props.fontSize}
                        fontFamily={this.props.fontFamily}>
                        {this.state.future.slice(1, Math.min(96, this.state.future.length)).map((word, index, arr) => {
                            return (
                                <Word
    ...
    handleScroll = (e) => {
        if (this.state.scroll == 15) {
            ...
            if (scrollDirection == "up") {
                future = fixationWindow.slice(0, fixationWindow.length).concat(future);
                fixationWindow = history.slice(history.length - 2).concat(trailingWord);
                trailingWord = history.slice(history.length - 3, history.length - 2);
                history = history.slice(0, history.length - 3);
                ...
                fixationWindow = future.slice(0,3);
                future = future.slice(3);
            }
